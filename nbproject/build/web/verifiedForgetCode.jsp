<%-- 
    Document   : verifiedForgetCode
    Created on : 14 May 2024, 2:05:48 pm
    Author     : Admin
--%>
            ...
            <div class="account-form">
                ...
                <div class="account-form-inner">
                    <div class="account-container">
                        ...
                        <!-- Email to get code if user Forget Password -->
                        <form class="contact-bx" action="forgetcode">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="hidden" name="codeFrom" value="${sessionScope.getEmailFromForgetPass.getCode()}">
                                            <input type="hidden" name="email" value="${sessionScope.getEmailFromForgetPass.getEmail()}">
