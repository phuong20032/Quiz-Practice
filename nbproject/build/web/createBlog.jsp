<%-- 
    Document   : createBlog
    Created on : May 14, 2024, 6:12:57 PM
    Author     : User
--%>
                ...
                <div class="page-banner ovbl-dark" style="background-image:url(assets/images/banner/banner3.jpg);">
                    <div class="container">
                        <div class="page-banner-entry">
                            <h1 class="text-white">- Create Blog -</h1>
                        </div>
                    </div>
                </div>
                <!-- Breadcrumb row -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-md-7">
                                ...
                                <form action="createblog" method="post">
                                    <input type="text" placeholder="Title:"  required name="title" /><br/><br/><br/>
                                    <input type="text" placeholder="Author:"  required name="author" /><br/><br/><br/>
                                    <input type="text" placeholder="Link Image:"   name="blog_img" /><br/><br/><br/>
                                    <input type="text" placeholder="Description:"  name="description" /><br/><br/><br/>
                                    <input type="hidden" name="creator_id" value="${sessionScope.account.getUser_id()}" readonly />
                                    <input type="text" placeholder="Blog Content:" name="blog_content"/><br/><br/><br/>
