                                ...
                                <div class="col-lg-8 col-xl-8">
                                    ...
                                    <div class="recent-news blog-lg">
                                        <div class="action-box blog-lg">
                                            <img src="${blogDetail.getBlog_img()}" alt="">
                                        </div>
                                        <div class="info-bx">
                                            <ul class="media-post">
                                                <li><a href="#"><i class="fa fa-calendar"></i></a>${blogDetail.getCreated_at()}</li>
                                                <li><a href="#"><i class="fa fa-comments-o"></i>10 Comment</a></li>

                                            </ul>
                                            <h5 class="post-title"><a href="#">${blogDetail.getTitle()}</a></h5>
                                            <p>${blogDetail.getBlog_content()}</p>
                                                ...
                                                <div class="widget-post clearfix">
                                                    ...
                                                    <div class="ttr-post-info">
                                                        <div class="ttr-post-header">
                                                            <h6 class="post-title"><a href="blog-details.jsp">title</a></h6>
                                                        </div>
                                                        <ul class="media-post">
